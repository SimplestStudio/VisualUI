...
# define WM_CHILD_KEYDOWN_THROUGH_NOTIFY (WM_APP + 9)
# define WM_SETTINGCHANGE_NOTIFY  (WM_APP + 10)
# define WM_DPICHANGED_NOTIFY     (WM_APP + 11)
# define WM_PAINT_LAYERED_CHILD   (WM_APP + 12)
# define WM_UPDATE_LAYERED_WINDOW (WM_APP + 13)
#else
# include <gdk/gdk.h>
